...
export default function ConfirmBookingError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[ConfirmBookingError]", error.message);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center gap-[16px] px-[24px] text-center">
      <h2 className="text-[20px] font-bold text-[#1a1a1a]">Booking error</h2>
      <p className="text-[14px] text-[#999] max-w-[320px]">
        Something went wrong during the booking process. Your payment has not been charged.
      </p>
